...
void initialiseDFA(dfa *myDFA){
    ...
    myDFA -> addTransition(6, 7, '-');
    myDFA -> addTransition(7, 7, '-'); 
    myDFA -> addTransition(6, 7, '_');
    myDFA -> addTransition(7, 7, '_');
    myDFA -> addTransition(6, 7, '&');
    myDFA -> addTransition(7, 7, '&');  
    myDFA -> addTransition(6, 7, 2);
    myDFA -> addTransition(7, 7, 2);     
    myDFA -> addTransition(6, 7, 1);
    myDFA -> addTransition(7, 7, 1);
    myDFA -> addTransition(6, 8, '\'');
